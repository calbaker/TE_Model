...
class PlateWall(object):
    ...
    def setup_transient(self):
        ...
        self.Bi = ( self.h * self.thickness / self.k ) # Biot number 
        self.Fo_crit = 1. / (2. * (1. + self.Bi))
        self.margin = (Fo_crit - Fo) / Fo_crit * 100.
        ...
        self.coeff_mat[0,0] = 1.
        self.coeff_mat[-1,-1] = 1.
        ...
        self.coeff_mat2 = np.zeros(self.T.shape[0])
