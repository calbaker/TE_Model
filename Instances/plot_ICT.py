...
plt.plot(hx_inst.x_dim * 100., hx_inst.te_pair.T_h_nodes, '-g', label='TE_PAIR Hot Side')
plt.plot(hx_inst.x_dim * 100., hx_inst.te_pair.T_c_nodes, '-k', label='TE_PAIR Cold Side')
plt.plot(hx_inst.x_dim * 100., hx_inst.cool.T_nodes, '-b', label='Coolant')

plt.plot(hx_fins0.x_dim * 100., hx_fins0.exh.T_nodes, '--r')
plt.plot(hx_fins0.x_dim * 100., hx_fins0.te_pair.T_h_nodes, '--g')
plt.plot(hx_fins0.x_dim * 100., hx_fins0.te_pair.T_c_nodes, '--k')
plt.plot(hx_fins0.x_dim * 100., hx_fins0.cool.T_nodes, '--b')

plt.plot(hx_ducts0.x_dim * 100., hx_ducts0.exh.T_nodes, ':r')
plt.plot(hx_ducts0.x_dim * 100., hx_ducts0.te_pair.T_h_nodes, ':g')
plt.plot(hx_ducts0.x_dim * 100., hx_ducts0.te_pair.T_c_nodes, ':k')
