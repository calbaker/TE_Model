...
plt.plot(gyp_mdot, gyp_Qdot, label='gypsum')
plt.plot(Cu_mdot, Cu_Qdot, label='Cu mesh')
...
plt.plot(gyp_T_in, gyp_Qdot, label='gypsum')
plt.plot(Cu_T_in, Cu_Qdot, label='Cu mesh')
plt.xlabel('Exhaust Mass Flow Rate (kg/s)')
plt.ylabel('Heat Transfer Rate (kW)')
plt.grid()
