...
mpl.figure()
mpl.plot(hx_parallel.x_dim, hx_parallel.exh.T_nodes, '-r', label='Exhaust')
mpl.plot(hx_parallel.x_dim, hx_parallel.tem.T_h_nodes, '-g', label='TEM Hot Side')
mpl.plot(hx_parallel.x_dim, hx_parallel.tem.T_c_nodes, '-k', label='TEM Cold Side')
mpl.plot(hx_parallel.x_dim, hx_parallel.cool.T_nodes, '-b', label='Coolant')
...
mpl.figure()
mpl.plot(hx_counter.x_dim, hx_counter.exh.T_nodes, '-r', label='Exhaust')
mpl.plot(hx_counter.x_dim, hx_counter.tem.T_h_nodes, '-g', label='TEM Hot Side')
mpl.plot(hx_counter.x_dim, hx_counter.tem.T_c_nodes, '-k', label='TEM Cold Side')
mpl.plot(hx_counter.x_dim, hx_counter.cool.T_nodes, '-b', label='Coolant')
